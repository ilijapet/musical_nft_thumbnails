...
const nft_contract = new ethers.Contract(nft_contract_address, ABI_NFT, signer);
const usdc_contract = new ethers.Contract(mock_usdc_address, ABI_USDC, signer);
